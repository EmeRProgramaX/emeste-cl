...
export const metadata: Metadata = {
  title: "Contacto",
  description: "Contacta a EMESTÉ.CL para páginas web, WhatsApp Business, Instagram, software, POS, automatización y soporte tecnológico.",
};

const contactOptions = [
  "Pack WhatsApp + Instagram",
  "Landing Express",
  "Web Profesional",
  "Software / POS / Automatización",
  "Soporte tecnológico",
];

export default function ContactoPage() {
  const whatsappUrl = buildWhatsappUrl("Hola EMESTÉ, quiero revisar mi negocio y saber qué servicio necesito.");
    ...
    <main className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      <section className="relative z-10 px-6 pb-20 pt-36">
        <div className="glass-pro glow-3d mx-auto max-w-7xl rounded-[2rem] p-8 text-center md:p-12">
          ...
          <h1 className="mx-auto max-w-5xl text-5xl font-black leading-tight md:text-7xl">Hablemos de tu negocio.</h1>
          <p className="mx-auto mt-7 max-w-3xl text-xl leading-relaxed text-zinc-200">
            EMESTÉ.CL responde con enfoque profesional para definir si necesitas WhatsApp + Instagram, una landing, web profesional, software, POS, automatización o soporte tecnológico.
          </p>
        </div>
      </section>
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="mx-auto grid max-w-6xl gap-6 md:grid-cols-2">
          <a href={whatsappUrl} target="_blank" rel="noreferrer" className="glass-pro glow-3d rounded-[2rem] p-8 text-center">
            <MessageCircle className="mx-auto mb-5 text-emerald-300" size={44} />
